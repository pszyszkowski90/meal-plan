...
```
✗ Nie można zarchiwizować: istniejące zmiany w stagingu zostałyby dołączone do commita archiwum.
...
5. **Zamknij pasujący element roadmapy.** Uruchom to przy **każdej** archiwizacji — wyszukiwanie roadmapy jest obowiązkowe. "Najlepszy wysiłek" obejmuje tylko *edycje*: brakująca roadmapa lub nieznaleziony cel edycji jest pomijany cicho i nigdy nie blokuje, nie wycofuje ani nie monituje archiwizacji. NIE oznacza to "założenia, że nie ma roadmapy i pominięcia sprawdzenia". Nie szukanie jest wadą — potwierdzenie (krok 7) musi zgłosić wynik w obu przypadkach.
   ...
   4. **Brak dopasowania** → wydrukuj `ℹ context/foundation/roadmap.md nie ma elementu z Change ID "<change-id>" — roadmapa pozostawiona bez zmian.` i pomiń resztę tego kroku. Dopasowanie jest tylko dokładnym ciągiem znaków; fragment roadmapy może generować kilka zmian, więc bliskie dopasowanie jest celowo *nie* zamykane.
...
- Krok zamykania roadmapy (krok 5 "Przenieś i oznacz") jest izolowany: każda awaria tam jest przechwytywana, odnotowywana w danych wyjściowych potwierdzenia i pomijana. Nigdy nie przerywa archiwizacji i nigdy nie wywołuje wycofania zmian. Częściowo zastosowana edycja roadmapy jest możliwa do odzyskania ręcznie.
