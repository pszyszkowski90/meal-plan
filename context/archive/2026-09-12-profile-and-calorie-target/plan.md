...
- [x] 3.1 `npx tsc --noEmit` czyste po regeneracji typed routes (`/profile` w typie, `/explore` poza nim) — 42b6917
- [x] 3.2 `npx expo lint` czyste, bez `react-hooks/set-state-in-effect` — 42b6917
- [x] 3.3 `npm test` nadal przechodzi — 42b6917
- [x] 3.4 `expo export` i `wrangler deploy --dry-run` bez modułów z `node_modules` — 42b6917
- [x] 3.5 Na `wrangler dev`: `GET /profile` HTML 200, `GET /explore` 404 — 42b6917
- [x] 3.6 `grep -rn "hint-row\|explore" src/` bez trafień — 42b6917
